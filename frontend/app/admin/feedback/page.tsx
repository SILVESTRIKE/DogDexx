                            ...
                            <DialogContent className="sm:max-w-[600px]">
                              ...
                              <div className="grid gap-4 py-4">
                                ...
                                <div className="grid grid-cols-4 items-center gap-4">
                                  ...
                                  <p className="col-span-3 font-bold">{f.feedbackContent?.isCorrect ? t('feedback.yes') : `${t('feedback.no')}, ${t('admin.feedback.dialog.mustBe')}: ${f.feedbackContent?.userSubmittedLabel ?? 'N/A'}`}</p>
                                </div>
                    ...
                    <PaginationContent>
                      <PaginationItem>
                        <PaginationPrevious
                          ...
                          className={feedbacks.page <= 1 ? "pointer-events-none opacity-50" : undefined}
                        />
                      </PaginationItem>
                      {[...Array(feedbacks.totalPages)].map((_, i) => (
                      ...
                      <PaginationItem>
                        <PaginationNext
                          ...
                          className={feedbacks.page >= feedbacks.totalPages ? "pointer-events-none opacity-50" : undefined}
                        />
                      </PaginationItem>
                    </PaginationContent>
                  </Pagination>
