...
const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'https://dogdex.onrender.com';

// Token management
// https://dogdex.onrender.com
// 10.46.71.150
...
export class ApiClient {
  ...
  public async getAccessToken(): string | null {
    return await TokenManager.getAccessToken();
  }

  public async setTokenUpdateCallback(
  ...
  public async request<T>(
    ...
    try {
      ...
      console.error('[ApiClient] Request failed1:', error, `(URL: ${url})`);
  ...
  async connectStreamPrediction(): Promise<WebSocket> {
    if (await TokenManager.getRefreshToken()) {
  ...
  async saveStreamPrediction(payload: {
