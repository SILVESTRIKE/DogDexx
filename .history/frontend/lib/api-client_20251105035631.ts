...
class BaseApiClient {
  ...
  protected async requestWithUploadProgress<T>(
    endpoint: string,
    formData: FormData,
...
class UserApiClient extends BaseApiClient {
  ...
  // Lấy chi tiết lịch sử dự đoán theo ID
...
class AdminApiClient extends BaseApiClient {
  ...
  // Lấy danh sách model và cấu hình AI
