...
export const approveAdminFeedback = async (feedbackId: string): Promise<{ message: string; data: Feedback }> => {
  return adminApiClient.adminApproveFeedback(feedbackId);
}

export const rejectAdminFeedback = async (feedbackId: string): Promise<{ message: string; data: Feedback }> => {
  return adminApiClient.adminRejectFeedback(feedbackId);
}
...
export const getAdminModelsAndConfigs = async (): Promise<{ data: { models: AIModel[], configs: AIConfiguration[] } }> => {
  return adminApiClient.getAdminModelsAndConfigs()
}

export const adminUpdateAIConfig = async (configId: string, params: AIConfigurationUpdatePayload): Promise<any> => {
  return adminApiClient.updateModelConfig({ configId, ...params });
}

export const adminActivateAIModel = async (modelId: string): Promise<any> => {
  return adminApiClient.adminActivateAIModel(modelId);
}
